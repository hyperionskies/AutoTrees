...
# build r Command Prompt command and run with subprocess
...
rcmd = '\"C:\\Program Files\\R\\R-3.6.0\\bin\\RScript\" ' + basedir + '\\unpack_v2.R' + ' ' + basedir + ' ' + dbfile
subprocess.run(rcmd)
...
blendcmd = '\"C:\\Program Files\\Blender Foundation\\Blender\\blender.exe\" -P ' + basedir + '\\animation_v2.py '
subprocess.run(blendcmd)
...
handbrakecmd = '\"C:\\Program Files\\HandBrakeCLI\" -i ' + basedir + '\\blender.avi -o ' + filename
subprocess.run(handbrakecmd)
